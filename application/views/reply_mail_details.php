    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Reply Mail</li>
            </ul>
        </div>
    </div>
    <div class="row">
        <div class="modal-body">
            <form role="form" class="form-horizontal" action="<?php echo base_url()?>evis_app/save_reply" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea name="message" class="form-control" id="inputBody" rows="14"><?php echo $message_info->message; ?> Reply ->>> </textarea>
                    </div>
                </div>
