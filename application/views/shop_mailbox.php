<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Mailbox For <?php echo $select_shop->name; ?> </h1>
            <ul class="breadcrumb">
                <li><a href="<?php echo base_url();?>">Home</a></li>
                <li><a href="<?php echo base_url();?>evis_app/mailbox">Mailbox</a></li>
                <li class="active"><?php echo $select_shop->name; ?></li>
            </ul>
        </div>
    </div>
    <div class="row">
    ...
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form role="form" class="form-horizontal" action="<?php echo base_url() ?>evis_app/save_mail" method="POST">
