    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="dataTable_wrapper">
                ...
                <form action="<?php echo base_url() ?>evis_app/save_expenditure" method="POST">
                    <div class="col-xs-2">
                ...
                <form action="<?php echo base_url() ?>evis_app/save_category" method="POST">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required name="category_name" class="form-control" placeholder="Category Name">
                        </div>
                        <button type="submit" class="btn btn-success">Save Category</button>
                        <a href="<?php echo base_url() ?>evis_app/manage_category" class="btn btn-info">Manage Category</a>
                    </div>
                </form>
            </div>
        </div>
